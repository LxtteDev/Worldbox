  ...
  [20],
  {
    "1fFI": function (e, o, t) {
      ...
      var a = t("nKUr"),
        ...
        h = t("7Qko"),
        g = t("20a2"),
        x = l.b.section.withConfig({
          displayName: "pre-register-form__PreRegisterFormStyleWrapper",
          componentId: "sc-yrt993-0",
        })(
          ["", ""],
          ".modal .modal-body{width:946px;height:716px;max-width:unset;box-shadow:0px 4px 16px rgba(0,0,0,0.08);padding:0px;overflow-y:unset}@media screen and (max-width: 767px){.modal .modal-body{width:414px;height:864px;overflow-y:auto}}.modal .modal-body .form{display:flex;overflow-y:auto;border-radius:12px}@media screen and (min-width: 768px){.modal .modal-body .form{height:716px;max-height:calc(80vh - 20px)}}@media screen and (max-width: 767px){.modal .modal-body .form{flex-wrap:wrap-reverse;padding:112px 24px 100px 24px}}.modal .modal-body .form .form-left,.modal .modal-body .form .form-right{width:473px;height:716px}@media screen and (max-width: 767px){.modal .modal-body .form .form-left,.modal .modal-body .form .form-right{width:100%;height:auto}}.modal .modal-body .form .form-left{background:#FFFFFF;padding:80px}@media screen and (max-width: 767px){.modal .modal-body .form .form-left{padding:0px}}.modal .modal-body .form .form-left .image-wrapper{width:181px;height:48px;margin-bottom:70px}@media screen and (max-width: 767px){.modal .modal-body .form .form-left .image-wrapper{position:absolute;top:24px;left:24px;margin-bottom:0px}}.modal .modal-body .form .form-left .loader{position:relative;top:-15px}@media screen and (max-width: 767px){.modal .modal-body .form .form-left .loader{top:-8px;width:max-content;margin:auto}}.modal .modal-body .form .form-left .thankyou-message{font-weight:400;font-size:24px;line-height:150%;margin-bottom:24px;color:#1F1637}.modal .modal-body .form .form-left .email-note{font-weight:400;font-size:16px;line-height:150%;color:#797091;margin-bottom:24px}.modal .modal-body .form .form-left .email-input{padding:13.5px 12px 13.5px 16px;font-weight:400;font-size:14px;line-height:150%;background:#FFFFFF;border:1px solid #EEEDF0;box-sizing:border-box;box-shadow:0px 2px 8px rgba(0,0,0,0.04);border-radius:8px;width:100%;margin-bottom:24px}.modal .modal-body .form .form-left .email-input::placeholder{color:#B5ACCD}.modal .modal-body .form .form-left .email-input:hover{border:1px solid #FF42A5;color:black}.modal .modal-body .form .form-left .email-input:hover::placeholder{color:#000000}.modal .modal-body .form .form-left .successful-registration{display:flex;font-weight:400;font-size:12px;line-height:150%;color:#398B4D;margin-top:3px}.modal .modal-body .form .form-left .successful-registration img{width:20px;height:20px;margin-right:10px}.modal .modal-body .form .form-left .promotional{display:flex;margin-bottom:80px}@media screen and (max-width: 767px){.modal .modal-body .form .form-left .promotional{margin-bottom:40px}}.modal .modal-body .form .form-left .promotional .checkbox{border:1px solid #5B5273;box-sizing:border-box;border-radius:2px;margin-right:8px;margin-top:2px;cursor:pointer}.modal .modal-body .form .form-left .promotional .checkbox-desc{font-weight:400;font-size:12px;line-height:150%;color:#B5ACCD}.modal .modal-body .form .form-left .submit-button{min-width:107px;height:48px;background:#E3DFEC;border-radius:8px;padding:12px 24px;font-weight:600;font-size:16px;line-height:150%;border:none;color:#B5ACCD}@media screen and (max-width: 767px){.modal .modal-body .form .form-left .submit-button{width:100%}}.modal .modal-body .form .form-left .submit-button-active{background:#FF42A5;color:#FFFFFF}.modal .modal-body .form .form-right{overflow:hidden;position:relative}.modal .modal-body .form .form-right .slider-cont-l,.modal .modal-body .form .form-right .slider-cont-r{position:absolute}.modal .modal-body .form .form-right .slider-cont-l{animation:left_animation 10s ease-in-out infinite;height:100%;width:100%}.modal .modal-body .form .form-right .slider-cont-l .slider-image-1{height:100%}@media screen and (max-width: 767px){.modal .modal-body .form .form-right .slider-cont-l .slider-image-1{padding-left:100px}}.modal .modal-body .form .form-right .slider-cont-r{animation:right_animation 10s ease-in-out infinite;height:100%;width:100%}.modal .modal-body .form .form-right .slider-cont-r .slider-image-2{height:100%}@media screen and (max-width: 767px){.modal .modal-body .form .form-right .slider-cont-r .slider-image-2{padding-left:100px}}@keyframes left_animation{0%{left:0%;background-color:#D7D7D7}30%{left:0%;background-color:#D7D7D7}50%{left:-100%;background-color:#de825e}80%{left:-100%;background-color:#de825e}100%{left:0%;background-color:#D7D7D7}}@keyframes right_animation{0%{left:100%;background-color:#D7D7D7}30%{left:100%;background-color:#D7D7D7}50%{left:0%;background-color:#de825e}80%{left:0%;background-color:#de825e}100%{left:100%;background-color:#D7D7D7}}@media screen and (max-width: 767px){.modal .modal-body .form .form-right{width:366px;height:284px;margin-bottom:40px;border-radius:8px}}\n"
        );
      o.default = function (e) {
        var o = e.isFormOpen,
          ...
          U = F[0],
          v = F[1],
          j = Object(m.useState)(!1),
          C = j[0],
          k = j[1],
          A = Object(m.useState)(!1),
          O = A[0],
          D = A[1],
          B = Object(g.useRouter)().asPath;
        Object(m.useEffect)(function () {
          var e = localStorage.pre_registered_games;
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        (a = Object(h.useUserAgent)(t).isMobile),
                        (r = Object(h.useUserAgent)(t).browser),
                        (e.next = 7),
                        f.a.post(
                          "https://us-central1-bluestacks-cloudv2.cloudfunctions.net/save-nowgg-pre-reg-data",
                          {
                            email: w,
                            is_subscribe: U,
                            app_id: c,
                    ...
                    case 7:
                      (i = e.sent) &&
                        200 === i.status &&
                        ((s = localStorage.pre_registered_games)
                          ? (s = s.split(","))
                          : (localStorage.setItem("pre_registered_games", ""),
                            (s = [])),
                        s.push(c),
                        localStorage.setItem(
                          "pre_registered_games",
                          s.join(",")
                        ),
                        k(!0)),
                        D(!1);
            ...
            children: Object(a.jsxs)("div", {
              ...
              children: [
                Object(a.jsxs)("div", {
                  ...
                  children: [
                    ...
                    Object(a.jsx)("div", {
                      ...
                      children: Object(a.jsx)(p.a, { id: "thankyounote" }),
                    }),
                    Object(a.jsx)("div", {
                      className: "email-note",
                      children: Object(a.jsx)(p.a, { id: "emailenternote" }),
                    }),
                    C
                      ? Object(a.jsxs)("div", {
                          ...
                          children: [
                            Object(a.jsx)("img", {
                              src: "https://cms-cdn.now.gg/cms-media/2022/05/Icon.png",
                            }),
                            Object(a.jsx)(p.a, {
                      ...
                      : Object(a.jsxs)("form", {
                          ...
                          children: [
                            ...
                            Object(a.jsx)("button", {
                              type: "submit",
                              className: "submit-button ".concat(
                                "" !== w && "submit-button-active"
                              ),
                              disabled: "" === w,
                              children: O
                                ? Object(a.jsx)("div", {
                ...
                Object(a.jsxs)("div", {
                  ...
                  children: [
                    Object(a.jsx)("div", {
                      className: "slider-cont-l",
                      children: Object(a.jsx)("img", {
                        className: "slider-image-1",
                        src: "https://cms-cdn.now.gg/cms-media/2022/05/l-img.png",
                      }),
                    }),
                    Object(a.jsx)("div", {
                      className: "slider-cont-r",
                      children: Object(a.jsx)("img", {
                        className: "slider-image-2",
                        src: "https://cms-cdn.now.gg/cms-media/2022/05/r-img.png",
                      }),
                    }),
                  ],
                }),
    ...
    deKR: function (e, o, t) {
      ...
      o.a = function (e) {
        var o = e.text,
          t = e.values;
        return o
          ? Object(a.jsx)(r.a, { id: o, values: t, defaultMessage: o })
          : null;
      };
    },
    tV3B: function (e, o, t) {
