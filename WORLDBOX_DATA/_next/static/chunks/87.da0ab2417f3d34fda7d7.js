          ...
          typeof (r = function () {
            ...
            (n.configure = function (n) {
              ...
              (n.render = function (e) {
                ...
                var i,
                  a = o.querySelector(t.barSelector),
            ...
            function a(n, t) {
              return (
                ("string" == typeof n ? n : l(n)).indexOf(" " + t + " ") >= 0
              );
            }
            function u(n, t) {
              var e = l(n),
    ...
    yDDw: function (n, t, e) {
      ...
      t.default = function () {
        return (
          ...
          r.Router.events.on("routeChangeStart", function () {
            return i.a.start();
          }),
          r.Router.events.on("routeChangeComplete", function () {
            return i.a.done();
          }),
          r.Router.events.on("routeChangeError", function () {
            return i.a.done();
          }),
          null
        );
