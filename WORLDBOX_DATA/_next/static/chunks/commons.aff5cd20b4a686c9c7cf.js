      ...
      t.a = function (e) {
        function t(e, n, c, l, f) {
                  ...
                  switch (
                    ...
                    case 64:
                      ...
                      if (
                        ...
                        0 < T &&
                          ((k = s(3, g, (M = r(j, G, L)), n, E, O, B, p, f, l)),
                          (G = M.join("")),
                          void 0 !== k &&
                            0 === (B = (g = k.trim()).length) &&
                            ((p = 0), (g = ""))),
                ...
                case 59:
                  if (
                    ...
                    switch (
                      ...
                      0 < T &&
                        void 0 !==
                          (k = s(1, G, n, e, E, O, H.length, l, f, l)) &&
                        0 === (B = (G = k.trim()).length) &&
                        (G = "\0\0"),
                      (h = G.charCodeAt(0)),
                      (p = G.charCodeAt(1)),
              ...
              case 10:
                47 === C
                  ...
                  : 0 === 1 + h &&
                    ...
                    0 < G.length &&
                    ((M = 1), (G += "\0")),
                  0 < T * z && s(0, G, n, e, E, O, H.length, l, f, l),
                  (O = 1),
                  E++;
                break;
              case 59:
          ...
          if (0 < (B = H.length)) {
            if (
              ((M = n),
              0 < T &&
                void 0 !== (k = s(2, H, M, e, E, O, B, l, f, l)) &&
                0 === (H = k).length)
            )
              return U + H + Y;
            if (((H = M.join(",") + "{" + H + "}"), 0 !== R * P)) {
        ...
        function l(e, r) {
          ...
          if ((33 > n.charCodeAt(0) && (n = n.trim()), (n = [n]), 0 < T)) {
            var i = s(-1, r, n, n, E, O, 0, 0, 0, 0);
            void 0 !== i && "string" === typeof i && (r = i);
          }
          var a = t(j, n, r, 0, 0);
          return (
            0 < T &&
              void 0 !== (i = s(-2, a, n, n, E, O, a.length, 0, 0, 0)) &&
              (a = i),
            "",
            (P = 0),
            (O = E = 1),
      ...
      (function (e) {
        ...
        var I = (function () {
          ...
          R = function (e) {
            ...
            for (; E.has(P); ) P++;
            var t = P++;
            return O.set(e, t), E.set(t, e), t;
          },
          j = function (e) {
            return E.get(e);
          },
          _ = function (e, t) {
            t >= P && (P = t + 1), O.set(e, t), E.set(t, e);
          },
          T = "style[" + w + '][data-styled-version="5.3.3"]',
          N = new RegExp(
            "^" + w + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)'
          ),
          z = function (e, t, r) {
              ...
              if (o) {
                ...
                if (s) {
                  var c = 0 | parseInt(s[1], 10),
                    l = s[2];
                  0 !== c &&
                    (_(l, c), z(e, l, s[3]), e.getTag().insertRules(c, n)),
                    (n.length = 0);
                } else n.push(o);
              }
            }
            ...
            function e(e, t, r) {
              void 0 === e && (e = v),
                ...
                !this.server &&
                  ...
                  (function (e) {
                    for (
                      var t = document.querySelectorAll(T), r = 0, n = t.length;
                      r < n;
                      r++
                    ) {
                      var i = t[r];
        ...
        function te(e) {
          var t,
            ...
            p = function (e, n, a) {
              return (0 === n && -1 !== ee.indexOf(a[r.length])) || a.match(i)
                ? e
                : "." + t;
            };
          function g(e, a, o, s) {
        ...
        function pe(e) {
          return ue.test(e) ? e.replace(de, he).replace(fe, "-ms-") : e;
        }
        var ge = function (e) {
          return null == e || !1 === e || "" === e;
        };
        ...
        function Ee(e) {
          ...
          for (var i = 0, a = r; i < a.length; i++) {
            var o = a[i];
            if (xe(o)) for (var s in o) Ie(s) && Oe(e, o[s], s);
          }
          return e;
        }
        ...
        function je(e, t, r) {
          ...
          n &&
            ...
            (C = t.shouldForwardProp
              ...
              : e.shouldForwardProp);
          var A,
            x = new K(r, w, n ? e.componentStyle : void 0),
            ...
            O = function (e, t) {
              return (function (e, t, r, n) {
                var a = e.attrs,
                  ...
                  })(be(t, Object(i.useContext)(Pe), s) || v, t, a),
                  g = p[0],
                  m = p[1],
                  b = (function (e, t, r, n) {
                    var i = oe(),
                ...
                return (
                  ...
                  (A.className = Array.prototype
                    .concat(c, d, b !== d ? b : null, t.className, m.className)
                    .filter(Boolean)
                    .join(" ")),
                  (A.ref = k),
          ...
          return (
            ...
            (A.withComponent = function (e) {
              var n = t.componentId,
                ...
                a = n && n + "-" + (Ae(e) ? e : Se(b(e)));
              return je(e, h({}, i, { attrs: S, componentId: a }), r);
            }),
        ...
        var _e = function (e) {
          return (function e(t, r, i) {
            if ((void 0 === i && (i = v), !Object(n.isValidElementType)(r)))
              return x(1, String(r));
            var a = function () {
              return t(r, i, ye.apply(void 0, arguments));
            };
            return (
        ...
        function Ne(e) {
          for (
            ...
            r[n - 1] = arguments[n];
          var o = ye.apply(void 0, [e].concat(r)),
            s = "sc-global-" + Ce(JSON.stringify(o)),
            c = new Te(o, s);
          function l(e) {
            var t = oe(),
              r = se(),
          ...
          function u(e, t, r, n, i) {
            if (c.isStatic) c.renderStyles(e, A, r, i);
              ...
              var a = h({}, t, { theme: be(t, n, l.defaultProps) });
